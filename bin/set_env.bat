...
set APPLICATION_SCRIPT_DIR=%PROJECT_DIR%\libs\scripts\
set INPUT_DIRECTORY=..\data_set\
set PATH_TO_WORDS=%INPUT_DIRECTORY%
set PATH_TO_NOISES=%INPUT_DIRECTORY%\noises\
set PATH_TO_BITMAPS=%APPLICATION_SCRIPT_DIR%\bitmaps\
set PATH_TO_DOC_TEMPLATES=%APPLICATION_SCRIPT_DIR%\templates\
